...
<p align="center">
 ...
 바야흐로 AI의 시대입니다. 창의성이라는 인간의 유일한 능력이라고 생각되었던 능력이 더 이상 인간만의 것이 아닌 새로운, 그리고 더 파워풀하고 속도가 빠른 존재에 이해서 위협을 받는 다는 이야기도 나오고 여러가지 공포스러운 가령 직업이 없어진다는 이야기도, 회사들이 망할 거라는 이야기도 나옵니다. 하지만 이는 모두 기술을 이해하지 못할 때 할 수 있는 이야기입니다. 과연 기술발전이 생산성에 있어서 효율을 높일까요 줄일까요? 개인의 역량을 낮출까요? 높여줄까요? 이 강의는 바로 그런 질문을 가지는 사람들에게 유용한 강의가 되고자 합니다. 우선적으로 현 시점에서 AI 이미지 생성과 관련된 기본적인 사용방법 긔리고 더욱 디테일한 사용법들을 살펴보고 건축과 디자인의 측면에서 사용될만한 쓰임새 들을 함께 살펴보고자 합니다. 

 결국 AI가 사람을 대체하는 것이 아니라 AI를 잘 활용 할 수 있는 사람이 경쟁력을 갖추고 역량을 향상시키고 더 나은 결과를 도출하는 것이 중오하기 때문입니다. 
 
이러한 방향과 기술을 알기위해서는 AI 기본 개념 이해해야 할 겁니다. 본 발표에서는 stable diffusion 툴의 기본 개념과 생각에 대해 차례대로 설명해 드리겠습니다.

툴은 건축 이미지 생성에 초점을 맞추어, 디자인 프로세스 전반에서 건축가에게 새로운 가능성을 탐색하고 영감을 제공하는 도구로 작동합니다. 이를 통해 설계 아이디어를 추상적인 방식으로 시각화를 지원하며, 최종 결과물을 제공해 디자인 과정에서 건축가를 돕는 역할을 수행합니다.

설명드릴 DIKW 모델과 창조적 디자인 프로세스를 결합해 생각해보면, 이 두 영역이 놀랍도록 유사한 논리적 구조를 갖고 있다는 점이 드러납니다. 인간의 디자인 프로세스와 AI가 결과물을 생성하는 방식의 비교는 디자인과 건축 분야에서 AI의 적용 가능성을 탐색하는 데 있어 중요한 기초를 제공합니다.
...
###**DIKW 모델- 데이터(Data)/정보(Information)/지식(Knowledge)/지혜 (Wisdom)**
 ...
 우선 DIKW 모델은 데이터, 정보, 지식, 지혜라는 네 가지 계층으로 구성되어 있으며, 다양한 주제에 대해 구조적이고 기능적으로 접근하는 데 도움을 줍니다. </p>
