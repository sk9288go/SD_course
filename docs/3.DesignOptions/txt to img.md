...
모델들은 '레시피'와 유사한 역할을 하며, 

사용자가 제공하는 텍스트 설명에 따라 이미지를 생성합니다. 

모델 파일들은 주로 **'.ckpt'** 확장명을 가지고 있으며, 

이를 통해 사용자들은 텍스트를 기반으로 이미지를 생성(Txt2img)하거나, 기존 이미지를 변환(Img2img)할 수 있습니다.
...
#### **1-1. Positive Prompt** 
 ...
 이미지의 스타일, 분위기, 구성 요소 등을 결정하는 데 핵심적인 역할을 합니다.
...
#### **1-2. Negative Prompt** 
 ...
 주로 제외될 확률을 높이는 역할을 하며, 이를 통해 더욱 정밀한 이미지 생성이 가능해집니다.
